...
[Migration("20260914222659_AddBaseCamp")]
partial class _20260914222659_AddBaseCamp
{
    /// <inheritdoc />
...
#pragma warning disable 612, 618
        ...
        modelBuilder.Entity("UniTracks.Games.BaseCamp.Persistence.CampLog", b =>
            {
                b.Property<Guid>("ID")
                    .ValueGeneratedOnAdd()
                    .HasColumnType("TEXT");

                b.Property<int>("BankedSupplies")
        ...
        modelBuilder.Entity("UniTracks.Games.BaseCamp.Persistence.CampModule", b =>
            {
                b.Property<Guid>("ID")
                    .ValueGeneratedOnAdd()
                    .HasColumnType("TEXT");
                ...
                b.ToTable("CampModules");
            });

        modelBuilder.Entity("UniTracks.Games.CityBuilder.Persistence.CityExpansion", b =>
            {
                b.Property<Guid>("ID")
                    .ValueGeneratedOnAdd()
                    .HasColumnType("TEXT");
        ...
        modelBuilder.Entity("UniTracks.Games.CityBuilder.Persistence.PlacedBuilding", b =>
            {
                b.Property<Guid>("ID")
                    .ValueGeneratedOnAdd()
                    .HasColumnType("TEXT");
        ...
        modelBuilder.Entity("UniTracks.Games.TowerDefense.Persistence.DefenseRecord", b =>
            {
                b.Property<Guid>("ID")
                    .ValueGeneratedOnAdd()
                    .HasColumnType("TEXT");
                ...
                b.ToTable("DefenseRecords");
            });

        modelBuilder.Entity("UniTracks.Games.TowerDefense.Persistence.DefenseRunProgress", b =>
            {
                b.Property<Guid>("ID")
                    .ValueGeneratedOnAdd()
                    .HasColumnType("TEXT");

                b.Property<int>("BestClearScore")
                    .HasColumnType("INTEGER");

                b.Property<int>("BestClearWave")
                    .HasColumnType("INTEGER");
                ...
                b.ToTable("DefenseRunProgresses");
            });

        modelBuilder.Entity("UniTracks.Games.TowerDefense.Persistence.EnergyPurchase", b =>
            {
                b.Property<Guid>("ID")
                    .ValueGeneratedOnAdd()
                    .HasColumnType("TEXT");
                ...
                b.ToTable("EnergyPurchases");
            });

        modelBuilder.Entity("UniTracks.Games.TowerDefense.Persistence.TowerUnlock", b =>
            {
                b.Property<Guid>("ID")
                    .ValueGeneratedOnAdd()
                    .HasColumnType("TEXT");
        ...
        modelBuilder.Entity("UniTracks.Models.Trip.Trip", b =>
            {
                b.HasOne("UniTracks.Models.Trip.TripType", "TripType")
                    .WithMany()
